...
public class PlayerPathNavigateGround extends PlayerPathNavigate
{
    protected WalkNodeProcessor field_179695_a;
    private boolean field_179694_f;
    //private static final String __OBFID = "CL_00002246";

    public PlayerPathNavigateGround(EntityPlayerSP player, World worldIn, PlayerMoveHelper playerMoveHelper)
    {
        super(player, worldIn, playerMoveHelper);
    }
    
    public PlayerPathNavigateGround(EntityPlayerSP player, World worldIn, PlayerMoveHelper playerMoveHelper, boolean shouldTrimToMinimal)
    {
        super(player, worldIn, playerMoveHelper);
        this.shouldTrimToMinimal = shouldTrimToMinimal;
    }
    
    public void setShouldTrimToMinimal(boolean value){
    	this.shouldTrimToMinimal = value;
    }
    
    public boolean getShouldTrimToMinimal(){
    	return this.shouldTrimToMinimal;
    }
